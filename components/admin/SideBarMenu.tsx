            ...
            <MenuItem
              ...
              icon={
                <PencilSquareIcon
                  fontSize={20}
                  className={`${
                    activeMenu === 11 ? " text-orange-400" : "text-[#8b99a4]"
                  } w-6 h-6 dark:text-white `}
                ></PencilSquareIcon>
              }
            ></MenuItem>
            <MenuItem
              ...
              icon={
                <PencilSquareIcon
                  fontSize={20}
                  className={`${
                    activeMenu === 12 ? " text-orange-400" : "text-[#8b99a4]"
                  } w-6 h-6 dark:text-white `}
                ></PencilSquareIcon>
              }
            ></MenuItem>
            <MenuItem
              ...
              icon={
                <PencilSquareIcon
                  fontSize={20}
                  className={`${
                    activeMenu === 13 ? " text-orange-400" : "text-[#8b99a4]"
                  } w-6 h-6 dark:text-white `}
                ></PencilSquareIcon>
              }
            ></MenuItem>
            <MenuItem
              ...
              icon={
                <PencilSquareIcon
                  fontSize={20}
                  className={`${
                    activeMenu === 14 ? " text-orange-400" : "text-[#8b99a4]"
                  } w-6 h-6 dark:text-white `}
                ></PencilSquareIcon>
              }
            ></MenuItem>
            ...
            <MenuItem
              ...
              icon={
                <KeyIcon
                  fontSize={20}
                  className={`${
                    activeMenu === 20 ? " text-orange-400" : "text-[#8b99a4]"
                  } w-6 h-6 dark:text-white `}
                ></KeyIcon>
              }
            ></MenuItem>
